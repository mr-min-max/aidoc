...
- Work only in `.worktrees/release-integrity` on `codex/release-integrity`; do not rewrite history, create another branch/worktree, merge, tag, publish, or change repository visibility.
