...
`0.3.0-beta.1` is the StaleDocs release candidate. The candidate uses the unscoped `staledocs` package and executable.
...
See [v0.3.0-beta.1](./releases/v0.3.0-beta.1.md).
