...
- Wordmark: retain `staledocs-wordmark.svg` as the compact scalable lockup for narrow integrations. The public README hero uses `docs/assets/demo/staledocs-flow-poster-source.png`, where the approved dimensional code-to-docs composition communicates the product more clearly than the compact mark.
