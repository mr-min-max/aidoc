...
- Wordmark: retain `aidoc-wordmark.svg` as the compact scalable lockup for narrow integrations. The public README hero uses `docs/assets/demo/aidoc-flow-poster-source.png`, where the approved dimensional code-to-docs composition communicates the product more clearly than the compact mark.
