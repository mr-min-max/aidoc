...
const pluginRoot = path.join(repositoryRoot, "integrations", "codex", "staledocs");
...
assert.deepEqual(manifest.interface, {
  ...
  developerName: "staledocs contributors",
...
assert.deepEqual(Object.keys(mcp.mcpServers), ["staledocs"]);
assert.deepEqual(mcp.mcpServers.staledocs, {
  command: "staledocs",
  args: ["--mcp"],
});
